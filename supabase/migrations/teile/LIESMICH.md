...
> **Es geht auch ohne Kopieren, und das ist der bessere Weg.** In GitHub unter
> **Actions → „Migrationen einspielen" → Run workflow** wird alles auf
> Knopfdruck eingespielt; nötig ist einmalig das Repository-Secret
> `SUPABASE_DB_URL` (siehe `docs/supabase-setup.md`). Am 05.09.2026 zeigte
> sich, dass der SQL-Editor auf dem Telefon auch bei 14-KB-Stücken abbricht —
> diese Stücke sind seither der Rückfallweg, nicht der erste.
